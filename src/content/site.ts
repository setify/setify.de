...
export const site: SiteContent = {
  ...
  process: {
    ...
    steps: [
      { number: '01', title: 'Anfrage', icon: 'search', text: 'Du schreibst uns über das Formular, in zwei Sätzen reicht völlig. Wir melden uns innerhalb eines Werktags, nicht mit einem Standardtext, sondern mit ersten Gedanken zu deinem Vorhaben und einem Terminvorschlag. Wenn wir merken, dass wir nicht die Richtigen sind, sagen wir auch das.', image: { id: 'process-anfrage', ratio: '3:4', label: 'Anfrage', alt: 'Hand notiert Stichpunkte auf einem Notizblock neben einem Telefon', prompt: 'Hochformat 3:4, realistische Fotografie, sehr hell und luftig. Skandinavisches Loft mit weissen Waenden und grossen Industriefenstern mit schlanken schwarzen Sprossen, unscharf im Hintergrund. Im Vordergrund scharf eine Tischplatte aus heller Eiche: eine Hand schreibt mit einem Aluminiumstift Stichpunkte auf ein Tablet, daneben ein geschlossener Aluminium-Laptop, ein schlichtes Keramikgefaess und ein flaches Notizbuch. Viel weiches Tageslicht von links, weiche Schatten, gut durchgezeichnet. Palette: helle Eiche, Sand #f3eee4 und #eae3d5, Anthrazit #1a1b1e, ein Goldakzent #bdac89 an einem Messingdetail. 50mm, f/2.8, natuerliche Hauttoene, korrekte Haende. Nur eine Hand im Bild, kein Gesicht. Kein Altbau, kein Stuck, kein dunkles Holz, keine Aktenordner, kein Desktop-Rechner, keine bunten Post-its, keine Logos.' } },
      { number: '02', title: 'Briefing', icon: 'lightbulb', text: 'In einem strukturierten Gespräch klären wir Ziele, Zielgruppe, Inhalte und Umfang. Wir fragen dabei auch nach dem, was oft untergeht: wer bei dir Inhalte liefert und wie schnell. Danach bekommst du ein festes Angebot mit klarem Leistungsumfang, kein Stundenschätzen und keine Nachforderungen.', image: { id: 'process-briefing', ratio: '3:4', label: 'Briefing', alt: 'Zwei Personen im Gespräch an einem hellen Tisch, eine skizziert eine Struktur', prompt: 'Hochformat 3:4, realistische Reportagefotografie, sehr hell und luftig. Zwei Personen Ende zwanzig bis Mitte dreissig halbnah im Seitenprofil an einem grossen Tisch aus heller Eiche, freundlich und konzentriert im Gespraech. Eine skizziert auf einem Tablet eine einfache Struktur, die andere lehnt sich vor und zeigt auf eine Stelle. Gesichter im Profil, kein Kamerablick. Skandinavisches Loft: weisse Waende, grosse Industriefenster mit schlanken schwarzen Sprossen, Designstuehle aus hellem Holz, ein Keramikgefaess mit getrockneten Graesern. Diffuses Tageslicht von links, weiche Schatten. Kleidung modern und leger: feiner Strickpullover, Leinenhemd, schlichtes T-Shirt, gedeckte Toene in Sand, Grau und Anthrazit. Palette: helle Eiche, #fbf9f4, #eae3d5, #1a1b1e, Goldstich #7a6a4c. 50mm, f/2.8, natuerliche Hauttoene, korrekte Haende. Kein Altbau, kein Stuck, keine Anzuege, keine Krawatten, kein Handschlag, kein Daumen hoch, keine Meeting-Stockfotografie, keine Logos.' } },
      { number: '03', title: 'Umsetzung', icon: 'penTool', text: 'Design und Entwicklung laufen transparent. Du bekommst früh einen Link auf den Zwischenstand und siehst die Seite wachsen, statt am Ende vor einem fertigen Entwurf zu stehen. Feedback gibst du direkt an der Stelle, an der es dir auffällt, und wir arbeiten es ein, bevor es teuer wird.', image: { id: 'process-umsetzung', ratio: '3:4', label: 'Umsetzung', alt: 'Designerin prüft einen Website-Entwurf auf einem großen Display', prompt: 'Hochformat 3:4, realistische Fotografie, sehr hell und ruhig. Eine einzelne Person Anfang dreissig sitzt seitlich an einem Schreibtisch aus heller Eiche vor einem aufgeklappten Aluminium-Laptop, daneben ein Tablet als zweite Flaeche. Auf beiden Schirmen derselbe Website-Entwurf: dunkle anthrazitfarbene Flaeche, grosse helle Headline, eine goldene Akzentzeile. Skandinavisches Loft mit weissen Waenden und grossem Industriefenster von rechts, viel Tageslicht, weiche Schatten, kein harter Reflex auf den Schirmen. Gesicht im Profil, freundlicher konzentrierter Ausdruck, kein Kamerablick. Kleidung modern und leger: schlichter Pullover in gedecktem Ton. Palette: helle Eiche, gebuerstetes Aluminium, Sand #f3eee4, Anthrazit #1a1b1e, Akzent #bdac89. 50mm, f/2.5, natuerliche Hauttoene, korrekte Haende. Nur eine Person. Kein klobiger Monitor, kein Desktop-Rechner, kein Altbau, kein Matrix-Gruen, keine RGB-Beleuchtung, kein Kabelwirrwarr, keine Logos.' } },
      { number: '04', title: 'Launch & Betreuung', icon: 'rocket', text: 'Wir gehen gemeinsam online und prüfen alles auf echten Geräten, nicht nur im Simulator. Danach bleiben wir ansprechbar: Updates, Backups und Ladezeiten laufen weiter über uns, und wenn du etwas ändern willst, schreibst du einer Person, die dein Projekt kennt.', image: { id: 'process-launch', ratio: '3:4', label: 'Launch & Betreuung', alt: 'Person prüft die fertige Website auf Laptop und Smartphone nebeneinander', prompt: 'Hochformat 3:4, realistische Fotografie, sehr hell und freundlich. Eine einzelne Person Mitte dreissig steht an einem Stehtisch aus heller Eiche und prueft die fertige Website auf zwei Geraeten nebeneinander: ein aufgeklappter Aluminium-Laptop und ein Smartphone in der Hand, auf beiden derselbe dunkle Entwurf mit heller Headline und goldener Akzentzeile. Halbnah von schraeg oben ueber die Schulter, Gesicht angeschnitten im Profil, entspannt und zufrieden, kein Kamerablick. Skandinavisches Loft: weisse Waende, grosses Industriefenster von rechts, viel Tageslicht, weiche Schatten, im Hintergrund unscharf ein offenes Holzregal mit Keramik. Kleidung modern und leger: Leinenhemd mit hochgekrempelten Aermeln, gedeckte Toene. Palette: helle Eiche, Sand #f3eee4 und #eae3d5, Anthrazit #1a1b1e, Akzent #bdac89. 50mm, f/2.5, natuerliche Hauttoene, korrekte Haende. Nur eine Person. Kein Altbau, keine Anzuege, kein Konfetti, keine Jubelgeste, kein Daumen hoch, keine Logos.' } },
    ],
  },
  work: {
    eyebrow: 'Referenzen',
