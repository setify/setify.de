...
export const site: SiteContent = {
  ...
  hero: {
    ...
    image: { id: 'hero-visual', ratio: '4:5', label: 'Hero-Visual', alt: 'Zwei Personen planen an einem hellen Holztisch gemeinsam eine Website, auf dem Laptop ein Seitenentwurf, daneben ausgedruckte Layoutbogen', prompt: 'Hochformat 4:5, realistische Fotografie, hell und luftig, skandinavisch, ruhige Apple-Anmutung. Zwei Personen planen gemeinsam eine Website an einem hellen Holztisch: eine Person zeigt auf den aufgeklappten Laptop, auf dem unscharf ein heller Website-Entwurf mit klarer Spaltenstruktur zu sehen ist, Text unlesbar. Daneben liegen zwei ausgedruckte Layoutbogen und ein Stift. Beide im Profil, im Gespraech, entspannt und freundlich, kein Kamerablick. Heller Raum mit weisser Wand, Holzdielen und einem grossen Fenster links, viel weiches Tageslicht, lange weiche Schatten, im Hintergrund unscharf ein schlichtes Regal und eine Pflanze. Casual, gut gekleidet, kein Anzug. Ruhige Flaeche oben im Bild. Palette: Sand #f3eee4 und #fbf9f4, helles Holz, Anthrazit #1a1b1e, Goldakzent #bdac89 an einem Messingdetail. 35mm, f/2.8, natuerliche Hauttoene, korrekte Haende, genau zwei Personen. Kein lesbarer Bildschirmtext, keine Code-Zeilen, keine bunten Haftnotizen, kein Meeting-Stockfoto, kein Daumen hoch, keine Logos, kein HDR.' },  },
  trust: {
    label: 'Vertrauen uns',
  ...
  industries: {
    ...
    lead: 'Wir kennen die Fragen, die deine Kunden stellen, bevor sie anrufen. Das entscheidet, was auf der Seite nach oben gehört.',
    items: [
