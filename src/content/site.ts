...
export const site: SiteContent = {
  ...
  process: {
    ...
    steps: [
      { number: '01', title: 'Anfrage', icon: 'search', text: 'Du schreibst uns über das Formular, in zwei Sätzen reicht völlig. Wir melden uns innerhalb eines Werktags, nicht mit einem Standardtext, sondern mit ersten Gedanken zu deinem Vorhaben und einem Terminvorschlag. Wenn wir merken, dass wir nicht die Richtigen sind, sagen wir auch das.', image: { id: 'process-anfrage', ratio: '3:4', label: 'Anfrage', alt: 'Hand notiert Stichpunkte auf einem Notizblock neben einem Telefon', prompt: 'Hochformat 3:4, realistische Reportagefotografie, hell und freundlich. Nahe Aufsicht auf einen hellen Eichentisch: eine Hand notiert mit einem mattschwarzen Fineliner Stichpunkte auf sandfarbenem Papier, daneben ein aufgeklapptes Notizbuch und ein Telefon mit dunklem Display, Bildschirm aus. Weiches Fensterlicht von links, lange ruhige Schatten. Palette: Sand #f3eee4 und #eae3d5, Anthrazit #1a1b1e, ein Goldakzent #bdac89 an einer Bueroklammer. 50mm, f/2.8, flache Schaerfe, natuerliche Hauttoene, korrekte Haende. Nur eine Hand im Bild, kein Gesicht. Keine Stockfoto-Gestik, keine bunten Post-its, kein Kaffeebecher, keine Logos.' } },
      { number: '02', title: 'Briefing', icon: 'lightbulb', text: 'In einem strukturierten Gespräch klären wir Ziele, Zielgruppe, Inhalte und Umfang. Wir fragen dabei auch nach dem, was oft untergeht: wer bei dir Inhalte liefert und wie schnell. Danach bekommst du ein festes Angebot mit klarem Leistungsumfang, kein Stundenschätzen und keine Nachforderungen.', image: { id: 'process-briefing', ratio: '3:4', label: 'Briefing', alt: 'Zwei Personen im Gespräch an einem hellen Tisch, eine skizziert eine Struktur', prompt: 'Hochformat 3:4, realistische Reportagefotografie, hell ausgeleuchtet. Zwei Personen halbnah im Seitenprofil an einem hellen Tisch, im konzentrierten Gespraech. Eine skizziert mit Bleistift eine einfache Struktur auf sandfarbenem Papier, die andere hoert zu und zeigt auf eine Stelle. Gesichter im Profil, kein Kamerablick. Heller Altbauraum mit hohem Fenster, diffuses Tageslicht von links, weiche Schatten. Kleidung gedeckt in Sand, Grau und Anthrazit. Palette: #fbf9f4, #eae3d5, #1a1b1e, Goldstich #7a6a4c. 50mm, f/2.8, natuerliche Hauttoene, korrekte Haende. Keine Anzuege, kein Handschlag, kein Daumen hoch, keine Meeting-Stockfotografie, keine Logos.' } },
      { number: '03', title: 'Umsetzung', icon: 'penTool', text: 'Design und Entwicklung laufen transparent. Du bekommst früh einen Link auf den Zwischenstand und siehst die Seite wachsen, statt am Ende vor einem fertigen Entwurf zu stehen. Feedback gibst du direkt an der Stelle, an der es dir auffällt, und wir arbeiten es ein, bevor es teuer wird.', image: { id: 'process-umsetzung', ratio: '3:4', label: 'Umsetzung', alt: 'Designerin prüft einen Website-Entwurf auf einem großen Display', prompt: 'Hochformat 3:4, realistische Fotografie, hell und ruhig. Eine einzelne Person sitzt seitlich vor einem grossen Display mit gebuerstetem Aluminiumrahmen und prueft einen Website-Entwurf: dunkle anthrazitfarbene Flaeche, grosse helle Headline, eine goldene Akzentzeile. Auf dem Tisch daneben ein Ausdruck mit Bleistiftnotizen. Grosses Fenster von rechts, viel Tageslicht, weiche Schatten, kein harter Reflex auf dem Schirm. Gesicht im Profil, kein Kamerablick. Palette: gebuerstetes Aluminium, Sand #f3eee4, Anthrazit #1a1b1e, Akzent #bdac89. 50mm, f/2.5, natuerliche Hauttoene, korrekte Haende. Nur eine Person. Kein Matrix-Gruen, keine RGB-Beleuchtung, kein Kabelwirrwarr, keine Logos.' } },
      { number: '04', title: 'Launch & Betreuung', icon: 'rocket', text: 'Wir gehen gemeinsam online und prüfen alles auf echten Geräten, nicht nur im Simulator. Danach bleiben wir ansprechbar: Updates, Backups und Ladezeiten laufen weiter über uns, und wenn du etwas ändern willst, schreibst du einer Person, die dein Projekt kennt.', image: { id: 'process-launch', ratio: '3:4', label: 'Launch & Betreuung', alt: 'Person prüft die fertige Website auf Laptop und Smartphone nebeneinander', prompt: 'Hochformat 3:4, realistische Fotografie, hell und freundlich. Eine einzelne Person prueft die fertige Website auf zwei Geraeten nebeneinander: ein aufgeklappter Aluminium-Laptop und ein Smartphone in der Hand, auf beiden derselbe dunkle Entwurf mit heller Headline und goldener Akzentzeile. Halbnah von schraeg oben ueber die Schulter, Gesicht angeschnitten, kein Kamerablick. Heller Arbeitsplatz aus Eiche, grosses Fenster von rechts, viel Tageslicht, weiche Schatten. Palette: Sand #f3eee4 und #eae3d5, Anthrazit #1a1b1e, Akzent #bdac89. 50mm, f/2.5, natuerliche Hauttoene, korrekte Haende. Nur eine Person. Kein Konfetti, keine Jubelgeste, kein Daumen hoch, keine Logos.' } },
    ],
  },
  work: {
    eyebrow: 'Referenzen',
